			...
			<article className="w-2/5 h-auto">
				...
				<section className="w-full bg-white rounded-[5px] h-auto border-[1px]">
					<div className="py-6 px-8 border-b-[1px]">
						<h3 className="font-medium text-2xl">Summary</h3>
					</div>

					<div className="py-6 px-8 border-b-[1px] flex items-end justify-between gap-4">
						<div className="w-1/2 ">
							<h3 className="text-4xl font-medium mb-2">0</h3>
							<p className="text-[18px] text-sec">All contacts</p>
						</div>
						<div className="w-1/2">
							<h3 className="text-2xl font-medium mb-2">0</h3>
				...
				<section className="w-full mt-8 bg-white rounded-[5px] h-auto border-[1px]">
					<div className="py-6 px-8 border-b-[1px]">
						<h3 className="font-medium text-2xl">Recent growth</h3>
				...
				<section className="w-full mt-8 bg-white rounded-[5px] h-auto border-[1px]">
					<div className="py-6 px-8 border-b-[1px]">
						<h3 className="font-medium text-2xl">Audience performance</h3>
						<p>Last 6 months.</p>
					</div>
			...
			<article className="w-3/5">
				...
				<section className="w-full bg-white rounded-[5px] h-[70vh] border-[1px]">
					<div className="py-6 px-8 border-b-[1px] flex items-center justify-between">
						<h3 className="font-medium text-2xl">Contacts growth</h3>
				...
				<section className="w-full mt-6 rounded-[5px] border-[1px] gap-2 bg-white h-auto">
					<div className="px-8 bg-[#EAECFB] py-8 flex items-stretch justify-between">
						<div className="w-3/5">
							<h3 className="text-2xl mb-2 font-medium">Account storage</h3>
							<p className="text-[18px]">
