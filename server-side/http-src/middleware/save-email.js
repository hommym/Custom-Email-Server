...
const outBox= require("../schemas/outbox-schema.js")
...
if(req.user){
   ...
   const savedEmail=await outBox.create({composedEmail:req.body.mailObject, senderId:req.id, organisation:req.user.userOrgnisation, state:"in-progress"})
