...
const { orgCreationController, contactsUploadController, loggedInController } = require("./userController.js");
...
userRouter.post("/upload-contacts/", verifyJWT, parseSingleFileFormData("contacts"), contactsUploadController);
